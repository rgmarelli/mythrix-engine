...
- A conversational or chat-style web UI. The on-demand AI Summary action (FR54) is a single-turn, stateless request per region — it carries no history and no memory across requests, and is distinct from the planned conversational agent layer above.
